# -*- coding: utf-8 -*-
"""
Created on Tue Jan 22 13:36:33 2019
...
def predictions2betas_curve(predictions,model_score_col='bogus_online_Model7',label_col='bogus_online',return_betas=True,plot_betas=False,axes=None,**kwargs):
    """
    ...
    **kwargs is for the plot function
    ...
    if plot_betas:
        ...
        axes.plot(betas['beta_bogus'],betas['beta_legit'],**kwargs)
        axes.set_ylabel('beta legit (% of bogus missed)')
        axes.set_xlabel('beta bogus (% of legit insulted)')
